...
- The folder `запас/` contains archived/unused code (LocalDBService, User.cs). Don't reference it from the live project; if a file reappears there, it's a backup, not a new feature.
